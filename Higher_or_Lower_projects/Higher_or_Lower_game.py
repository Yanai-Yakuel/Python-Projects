...
data = [
    ...
    {'name': 'Dwayne Johnson', 'follower_count': 200, 'description': 'Actor and professional wrestler', 'country': 'United States'},
    {'name': 'Selena Gomez', 'follower_count': 190, 'description': 'Musician and actress', 'country': 'United States'},
    ...
    {'name': 'Kim Kardashian', 'follower_count': 500, 'description': 'Reality TV personality and businesswoman', 'country': 'United States'},
    {'name': 'Lionel Messi', 'follower_count': 400, 'description': 'Footballer', 'country': 'Argentina'},
    {'name': 'Beyoncé', 'follower_count': 130, 'description': 'Musician', 'country': 'United States'},
    {'name': 'Neymar', 'follower_count': 240, 'description': 'Footballer', 'country': 'Brasil'},
...
while game_should_continue:
    # Assign account A to the previous account B and get a new account B
    account_a = account_b
    account_b = random.choice(data)

    # Ensure account B is different from account A
    ...
    # Clear the screen (optional, replace with your environment's method)
    print("\n" * 20)
